...
public class Map {
	...
	public boolean checkMapLeft(int x, int y, int width, int height) {
		...
		for (int i = 0; i < height; i++) {
			if (getMap(x / Board.getTilesize(), y / Board.getTilesize()).equals("2"))
				return false;
			else if (getMap(x / Board.getTilesize(), y / Board.getTilesize()).equals("1"))
				return false;
			else if (getMap(x / Board.getTilesize(), y / Board.getTilesize()).equals("3"))
				return false;
			else {
				y = y + 1;
			}
